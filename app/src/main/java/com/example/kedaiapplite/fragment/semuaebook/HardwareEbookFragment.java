...
public class HardwareEbookFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_hardware_ebook, container, false);
    }
    @Override
    ...
    public void getDataEbook(){
        ...
        Call<DataEbook> call = apiInterface.getDataKategoriHardwareiEbook();
        call.enqueue(new Callback<DataEbook>() {
            ...
            public void onResponse(Call<DataEbook> call, Response<DataEbook> response) {
                ...
                if (response.isSuccessful() &&  response.body() != null){
                    rv = v.findViewById(R.id.rv_ebookhardware);
