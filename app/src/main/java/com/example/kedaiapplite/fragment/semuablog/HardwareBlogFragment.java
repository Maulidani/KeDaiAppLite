...
public class HardwareBlogFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_hardware_blog, container, false);
    }
    @Override
    ...
    public void getDataBlog(){
        ...
        Call<DataBlog> call = apiInterface.getDataKategoriHardwareiBlog();
        call.enqueue(new Callback<DataBlog>() {
            ...
            public void onResponse(Call<DataBlog> call, Response<DataBlog> response) {
                ...
                if (response.isSuccessful() &&  response.body() != null){
                    rv = v.findViewById(R.id.rv_bloghardware);
